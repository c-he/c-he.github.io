...
# Self-heal: if the image's baked gems don't match the current Gemfile.lock
# (e.g. a lock bump or a stale cached image), install what's missing instead
# of failing with Bundler::GemNotFound.
ensure_bundle_deps() {
